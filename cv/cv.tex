...
\begin{document}
    ...
    \section{Skills}
        ...
        \vspace{0.1 cm}
         ...
         \begin{onecolentry}
            \textbf{Technologies:} Docker, Postgres, Amazon AWS, Openshift, Terraform, MongoDB, Corda DLT, Gradle, SpringBoot
        \end{onecolentry}

        \vspace{0.1 cm}

         \begin{onecolentry}
            \textbf{Others:} Problem Solving, Hard-working, Teamwork, Business-Driven/Domain-Driven Design, Scrum, Agile
        \end{onecolentry}
